...
var MAE_CodComunicacion = (function (_super) {
    __extends(MAE_CodComunicacion, _super);
    function MAE_CodComunicacion() {
        var _this = _super.call(this) || this;
        _this.alert = new AlertHelper();
        _this.modalCanvas = "#modalCanvas";
        _this.modalName = "#modalTipo";
        _this.formName = "#formTipo";
        _this.urlGetTable = "/Admin/CodCom/getTable";
        _this.modalForm = new ModalHelper(_this.modalName);
        var tableHelper = new TableHelper('#tablaDatos', true);
        return _this;
    }
    MAE_CodComunicacion.prototype.initModal = function (data, status, xhr) {
    ...
    MAE_CodComunicacion.prototype.InitModalTipo = function (data, status, xhr) {
        $.validator.unobtrusive.parse($(this.formName));
    ...
    MAE_CodComunicacion.prototype.InitModalEdit = function (data, status, xhr) {
        $.validator.unobtrusive.parse($(this.formName));
        $('.i-checks').iCheck({
            checkboxClass: 'icheckbox_square-green',
            radioClass: 'iradio_square-green',
    ...
    MAE_CodComunicacion.prototype.saveResult = function (data, status, xhr) {
        if (data == 'true') {
