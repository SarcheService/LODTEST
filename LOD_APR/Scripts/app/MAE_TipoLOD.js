...
var MAE_TipoLOD = (function (_super) {
    ...
    MAE_TipoLOD.prototype.InitModalTipo = function (data, status, xhr) {
        $.validator.unobtrusive.parse($(this.formName));
    ...
    MAE_TipoLOD.prototype.InitModalEdit = function (data, status, xhr) {
        $.validator.unobtrusive.parse($(this.formName));
        $('.i-checks').iCheck({
            checkboxClass: 'icheckbox_square-green',
            radioClass: 'iradio_square-green',
    ...
    MAE_TipoLOD.prototype.saveResult = function (data, status, xhr) {
        if (data == 'true') {
